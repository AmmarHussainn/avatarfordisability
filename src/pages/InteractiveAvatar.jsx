...
const MultiStepForm = ({
  ...
  const handleChange = (field, value, appointmentIndex = null, nestedField = null) => {
  ...
  const removeAppointment = (index) => {
    setFormData((prev) => ({
      ...prev,
      medicalAppointments: prev.medicalAppointments.filter((_, i) => i !== index),
    }));
    setErrors((prev) => {
      const newErrors = { ...prev };
      Object.keys(newErrors).forEach((key) => {
        if (key.startsWith(`medicalAppointments[${index}].`)) delete newErrors[key];
      });
      return newErrors;
    });
  };
  ...
  const validateStep = (step) => {
    ...
    if (step === 1) {
      ...
      if (formData.conditionChanges.hasChanges && !formData.conditionChanges.description.trim()) {
        newErrors['conditionChanges.description'] = 'Description is required';
      }
      if (formData.activityLimitations.hasLimitations && !formData.activityLimitations.examples.trim()) {
        ...
        if (currentStep < 3) {
          if (avatarRef.current) {
            await avatarRef.current.speak({
              text: currentStep === 1 
                ? "Now let's go over your recent medical appointments." 
                : "Finally, we'll ask about any changes in your condition or daily activities.",
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full text-[var(--input-text)] px-3 py-2 border ${
                    errors.ssn ? 'border-red-500' : 'border-[var(--border-color)]'
                  } rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]`}
                  ...
                  <div className='space-y-4'>
                    <div className='grid grid-cols-2 gap-4'>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleChange('doctorName', e.target.value, index)}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleChange('officeName', e.target.value, index)}
                          className={`w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleChange('medicalConditionsTreated', e.target.value, index)}
                        className={`w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]`}
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                      ...
                      <div>
                        ...
                        <input
                          type='tel'
                          value={appt.fax}
                          onChange={(e) => handleChange('fax', e.target.value, index)}
                          className={`w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]`}
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleChange('dateOfLastAppointment', e.target.value, index)}
                          className={`w-full px-3 py-2 text-[var(--input-text)] border ${
                            errors[`medicalAppointments[${index}].dateOfLastAppointment`]
                              ? 'border-red-500'
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleChange('dateOfNextAppointment', e.target.value, index)}
                          className={`w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]`}
                        />
                      </div>
                    </div>
                        ...
                        <div className='flex flex-wrap gap-2'>
                          <label className='flex items-center gap-2'>
                            <input
                              ...
                              onChange={(e) => handleChange('isNewDoctor', e.target.checked, index)}
                          ...
                          <label className='flex items-center gap-2'>
                            <input
                              ...
                              onChange={(e) => handleChange('isDoctorSeenPreviously', e.target.checked, index)}
                              className='form-checkbox'
                            />
                            Seen Previously
                          </label>
                          <label className='flex items-center gap-2'>
                            <input
                              ...
                              onChange={(e) => handleChange('isFamilyDoctor', e.target.checked, index)}
                              className='form-checkbox'
                            />
                            Family Doctor
                          </label>
                          <label className='flex items-center gap-2'>
                            <input
                              ...
                              onChange={(e) => handleChange('isSpecialist', e.target.checked, index)}
                              className='form-checkbox'
                            />
                            Specialist
                          </label>
                      ...
                      {appt.isSpecialist && (
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => handleChange('specialistType', e.target.value, index)}
                            className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
                      ...
                      <div className='flex items-center gap-4'>
                        <label className='flex items-center gap-2'>
                          <input
                            ...
                            onChange={(e) => handleChange('testingOrdered', e.target.checked, index)}
                            className='form-checkbox'
                          />
                          Yes
                        </label>
                          ...
                          <>
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => handleChange('testingType', e.target.value, index)}
                                className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => handleChange('testingWhen', e.target.value, index)}
                                className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
                              />
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => handleChange('testingFacility', e.target.value, index)}
                                className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
            ...
            <>
              <div className='border p-4 rounded-md mb-4'>
                ...
                <div className='space-y-4'>
                  <div>
                    <label className='block text-sm font-medium text-[var(--label-text)] mb-1'>
                      Have your medical conditions and/or symptoms changed or gotten worse in the last 60 days?
                    </label>
                    <div className='flex gap-4'>
                      <label className='flex items-center gap-2'>
                        <input
                          type='radio'
                          name='hasChanges'
                          checked={formData.conditionChanges.hasChanges === true}
                          onChange={() => handleChange('hasChanges', true, null, 'conditionChanges')}
                      ...
                      <label className='flex items-center gap-2'>
                        <input
                          type='radio'
                          name='hasChanges'
                          checked={formData.conditionChanges.hasChanges === false}
                          onChange={() => handleChange('hasChanges', false, null, 'conditionChanges')}
                          className='form-radio'
                        />
                        No
                      </label>
                    ...
                    <>
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) => handleChange('description', e.target.value, null, 'conditionChanges')}
                          className={`w-full px-3 py-2 text-[var(--input-text)] border ${
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleChange('whenChanged', e.target.value, null, 'conditionChanges')}
                          className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
                        />
                      </div>
                    </>
              ...
              <div className='border p-4 rounded-md mb-4'>
                ...
                <div className='space-y-4'>
                  <div>
                    <label className='block text-sm font-medium text-[var(--label-text)] mb-1'>
                      Any new changes or limitations in your day-to-day activities (cooking, cleaning, personal care, shopping, driving, socializing, etc.) in the last 60 days?
                    </label>
                    <div className='flex gap-4'>
                      <label className='flex items-center gap-2'>
                        <input
                          type='radio'
                          name='hasLimitations'
                          checked={formData.activityLimitations.hasLimitations === true}
                          onChange={() => handleChange('hasLimitations', true, null, 'activityLimitations')}
                          className='form-radio'
                        />
                        Yes
                      </label>
                      <label className='flex items-center gap-2'>
                        <input
                          type='radio'
                          name='hasLimitations'
                          checked={formData.activityLimitations.hasLimitations === false}
                          onChange={() => handleChange('hasLimitations', false, null, 'activityLimitations')}
                          className='form-radio'
                        />
                        No
                      </label>
                  ...
                  {formData.activityLimitations.hasLimitations && (
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleChange('examples', e.target.value, null, 'activityLimitations')}
                        className={`w-full px-3 py-2 text-[var(--input-text)] border ${
                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChange('name', e.target.value, null, 'emergencyContact')}
                      className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChange('phone', e.target.value, null, 'emergencyContact')}
                      className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
                      placeholder='Enter phone number'
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChange('relationship', e.target.value, null, 'emergencyContact')}
                      className='w-full px-3 py-2 text-[var(--input-text)] border border-[var(--border-color)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] bg-[var(--input-bg)]'
